...
const Libros = () => {
    ...
    const handleSave = async () => {
        try {
            if (editing) {
                await axios.put(`http://localhost:8005/api/libros/editar/${currentLibro.id}`, currentLibro);
            } else {
                await axios.post('http://localhost:8005/api/libros/crear', currentLibro);
            }
            fetchLibros();
            handleClose();
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:8005/api/libros/eliminar/${id}`);
            fetchLibros();
        } catch (error) {
