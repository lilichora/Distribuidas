...
const Inventario = () => {
    ...
    const fetchInventario = async () => {
        try {
            const response = await axios.get('http://18.119.120.45:8006/api/inventario');
    ...
    const handleSave = async () => {
        try {
            if (editing) {
                await axios.put(`http://18.119.120.45:8006/api/inventario/editar/${currentInventario.id}`, currentInventario);
            } else {
                await axios.post('http://18.119.120.45:8006/api/inventario/crear', currentInventario);
            }
            fetchInventario();
            handleClose();
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://18.119.120.45:8006/api/inventario/eliminar/${id}`);
            fetchInventario();
        } catch (error) {
