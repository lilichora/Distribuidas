...
const Prestamos = () => {
    ...
    const fetchPrestamos = async () => {
        try {
            const response = await axios.get('http://18.119.120.45:8002/api/prestamos');
    ...
    const handleSave = async () => {
        try {
            if (editing) {
                await axios.put(`http://18.119.120.45:8002/api/prestamos/editar/${currentPrestamo.id}`, currentPrestamo);
            } else {
                await axios.post('http://18.119.120.45:8002/api/prestamos/crear', currentPrestamo);
            }
            fetchPrestamos();
            handleClose();
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://18.119.120.45:8002/api/prestamos/eliminar/${id}`);
            fetchPrestamos();
        } catch (error) {
